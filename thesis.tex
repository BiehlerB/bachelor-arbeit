...
\input{content/02_mensch-roboter-interaktion.tex}		
\input{content/03_interakt-visuell-robotersteuerung.tex}			
\input{content/04_roboter-ansteuerung.tex}		
\input{content/05_benutzerzentrierte-auswertung.tex}
\input{content/06_evaluierung.tex}
\input{content/07_zusammenfassung-ausblick.tex}	

\appendix
% Hier beginnt der Anhang, nummeriert in lateinischen Buchstaben
\input{content/a_statistik.tex}
\input{content/b_style-guide.tex}
...
\cleardoublepage
\input{content/z_eid_versicherung.tex}
\end{document}
